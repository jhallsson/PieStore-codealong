...
namespace codealong_pie_project.Models
{
    ...
    //DbContext  //The database manager - session till databas, gör att man kan göra queries till den och spara data
    {
        public AppDbContext(DbContextOptions<AppDbContext> options) : base(options) //AppDbContext = The type of the context these options apply to.
        {

        }
        //Wich entites that should be managed
        //databasens "tabeller"
        public DbSet<Pie> Pies { get; set; } //skapar ett set? så man kan quera och spara pie-objekt
        public DbSet<Category> Categories { get; set; } //Category/Pie = TEntity = entity typ
        ...
        //copy-paste seeded data - går upp med nästa migration
